    ...
    protected void loadData() {
        ...
        smartRefreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshlayout) {
                ...
                LoadDate.loadTopticsData(true, "deals", listView, smartRefreshLayout, getActivity().getLayoutInflater(), getActivity(), loadingLayout);

            }
        });
        LoadDate.loadTopticsData(false, "deals", listView, smartRefreshLayout, getActivity().getLayoutInflater(), getActivity(), loadingLayout);
